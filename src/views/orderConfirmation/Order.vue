...
const useMakeOrderEffect = (shopId, shopName, productList) => {
  ...
  return { handleConfirmOrder, toastMessage, show }
}
...
export default {
  ...
  setup () {
    ...
    const { handleConfirmOrder, toastMessage, show } = useMakeOrderEffect(shopId, shopName, productList)
    const { showConfirm, handleShowConfirmChange } = useShowMaskEffect()
    return { showConfirm, handleShowConfirmChange, calculations, handleConfirmOrder, show, toastMessage }
  }
}
</script>
